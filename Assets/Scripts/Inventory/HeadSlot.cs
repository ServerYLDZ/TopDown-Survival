...
public class HeadSlot : MonoBehaviour, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        {
            if (itm.item.type == ItemTpe.Armor && itm.item.prefab.GetComponent<Armor>().armorType == Armor.ArmorType.Head) // ormorsa ve kalkansa
            {
