...
public class FootSlot : MonoBehaviour, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        {
            if (itm.item.type == ItemTpe.Armor && itm.item.prefab.GetComponent<Armor>().armorType == Armor.ArmorType.Foot) // ormorsa ve kalkansa
            {
